...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-[#21CDAA] text-white hover:bg-[#1bb598] focus:ring-[#21CDAA]',
    secondary: 'bg-gray-200 text-gray-900 hover:bg-gray-300 focus:ring-gray-500',
    outline: 'border-2 border-[#21CDAA] text-[#21CDAA] hover:bg-[#21CDAA] hover:text-white focus:ring-[#21CDAA]'
  };
